...
-- JustAC: Options/StandardQueue - Standard Queue panel settings (layout, visibility, appearance, system)
local StandardQueue = LibStub:NewLibrary("JustAC-OptionsStandardQueue", 1)
...
function StandardQueue.CreateTabArgs(addon)
    return {
        ...
        args = {
            info = {
                type = "description",
                name = L["Standard Queue description"],
                order = 1,
                fontSize = "medium"
            },
            -- ICON LAYOUT (10-19)
            ...
            resetDefaults = {
                ...
                desc = L["Reset Standard Queue desc"],
                order = 991,
                width = "normal",
                func = function()
