...
L["Require Hostile Target desc"] = "Out of combat: only show the queue when targeting a hostile unit. In combat: always show. Disabled when 'Hide Out of Combat' is enabled (has no effect)."
