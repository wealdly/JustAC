...
if L then
    ...
    L["Highlight Mode desc"] = "Quels effets lumineux afficher sur les icônes de sorts"
...
if L then
    ...
    L["Highlight Mode desc"] = "Quais efeitos de brilho mostrar nos ícones de magias"
