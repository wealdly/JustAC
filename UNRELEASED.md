...
- The same check found dead entries in the healer suggestions themselves: Holy Priests were being offered Circle of Healing, Restoration Druids Grove Guardians, and Discipline Priests Rapture - none of which exist to cast any more. Preservation Evokers now get the right version of Dream Breath
- Warlocks: the Succubus is summoned as Sayaad now, so the pet summon reminder works again. The Warlock pet *heal* reminder has been retired - Health Funnel is gone from the game and nothing has replaced it, so the cue could never appear. Hunter pet heals are unaffected
