...
L["Interrupt Mode desc"] = "Controls when to show the interrupt/CC icon.\n\nOff: disabled.\nImportant Only: kick lethal/must-interrupt casts only.\nImportant + CC: kick important casts; CC non-important casts (saves kick lockout \u2014 no reminder if CC unavailable).\nAll + Smart CC: kick important casts; CC non-important, but fall back to kick if no CC is ready.\nAll Casts: kick every interruptible cast regardless of importance."
L["Interrupt Off"] = "Off"
L["Interrupt Important"] = "Important Only"
L["Interrupt Important CC"] = "Important + CC"
L["Interrupt All CC"] = "All + Smart CC"
