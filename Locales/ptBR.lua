...
L["Interrupt Mode Disabled"] = "Desativado — Sem sugestões de interrupção"
L["Interrupt Mode Kick Only"] = "Apenas Kick — Sugerir kick para feitiços interrompíveis"
L["Interrupt Mode CC Shielded"] = "Kick + CC — Também sugerir atordoamento/medo para feitiços protegidos"
L["Interrupt Mode CC Prefer"] = "Preferir CC — Atordoamentos em vez de kicks em alvos controláveis; kick em chefes"
