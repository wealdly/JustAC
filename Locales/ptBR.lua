...
L["Nameplate Defensive Display Mode desc"] = "Quando vida baixa: apenas quando a vida cai abaixo dos limites.\nApenas em combate: ícones defensivos apenas em combate.\nSempre: mostrar o tempo todo."
...
L["Reset Appearance desc"] = "Redefinir ajustes de visibilidade e aparência para os padrões."
L["Reset Offensive desc"] = "Redefinir ajustes de conteúdo ofensivo. A lista negra não é afetada."
L["Reset Overlay desc"] = "Redefinir todos os ajustes do Overlay para os valores padrão."
L["Reset Defensives desc"] = "Redefinir ajustes de conteúdo defensivo. As listas de magias não são afetadas."
