...
L["Queue Settings"] = "Warteschlangen-Einstellungen"
...
L["Interrupt Mode Disabled"] = "Deaktiviert — Keine Unterbrechungsvorschläge"
L["Interrupt Mode Kick Only"] = "Nur Kick — Unterbrechung bei unterbrechbaren Zaubern"
L["Interrupt Mode CC Shielded"] = "Kick + CC — Auch Betäubung/Furcht bei ununterbrechbaren (geschützten) Zaubern"
L["Interrupt Mode CC Prefer"] = "CC bevorzugen — Betäubungen statt Kicks bei kontrollierbaren Zielen; Kick bei Bossen"
