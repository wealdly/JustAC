...
L["Show Gap-Closer Glow desc"] = "Show a red emphasis glow on gap-closer icons to highlight that they are available."
...
L["Interrupt Mode Disabled"] = "Disabled — No interrupt suggestions"
L["Interrupt Mode Kick Only"] = "Kick Only — Suggest kick for interruptible casts"
L["Interrupt Mode CC Shielded"] = "Kick + CC — Also suggest stun/fear for uninterruptible (shielded) casts"
L["Interrupt Mode CC Prefer"] = "Prefer CC — Suggest stuns over kicks on CC-able targets; kick on bosses"
