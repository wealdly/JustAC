...
L["Disable Main Queue"] = "Disable Main Queue"
...
L["Disable Main Queue desc"] = "Permanently hide the main queue panel. The Nameplate Overlay can still be used independently."
...
L["Enable Nameplate Overlay"] = "Enable Nameplate Overlay"
