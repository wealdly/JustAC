...
L["Blacklist Info"] = "Hide spells from positions 2+ in the queue. Position 1 (Blizzard's primary suggestion) is never filtered — hiding it would freeze the rotation.\n\n|cffff6666Shift+Right-click|r a spell to toggle blacklist."
