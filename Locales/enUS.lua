...
L["Hide spell desc"] = "Hide this spell from queue positions 2+ (the rotation list). Position 1 is Blizzard's primary suggestion and is never filtered."
...
L["Controlled by the Defensives tab when defensive suggestions are enabled."] = "Controlled by the Defensives tab when defensive suggestions are enabled."
L["see Defensives tab"] = "see Defensives tab"
...
L["Nameplate Show Interrupt"] = "Show Interrupt Reminder"
L["Nameplate Show Interrupt desc"] = "Show your interrupt ability as a position-0 icon when the target is casting an interruptible spell. Includes a stronger glow for must-interrupt casts."
L["Show Interrupt"] = "Show Interrupt Reminder"
L["Show Interrupt desc"] = "Show your interrupt ability before slot 1 when the target is casting an interruptible spell. Includes a stronger glow for must-interrupt casts."
