...
L["Burst Injection Experimental Note"] = "This feature is experimental and may not work perfectly for all specs. Feedback welcome!"
L["Burst Injection Behavior Note"] = "When Blizzard recommends a long-cooldown spell, a burst window opens and your configured priority spells are injected at position 1."
L["Enable Burst Injection"] = "Enable Burst Injection"
L["Enable Burst Injection desc"] = "Detect burst windows and inject priority spells at position 1."
L["Show Burst Glow"] = "Show Burst Glow"
L["Show Burst Glow desc"] = "Show a purple emphasis glow on burst-injected icons."
L["Burst Window Duration"] = "Burst Window Duration"
L["Burst Window Duration desc"] = "How long (seconds) the burst window stays active after a trigger fires."
L["Burst Trigger Threshold"] = "Trigger Cooldown Threshold"
L["Burst Trigger Threshold desc"] = "Spells with a base cooldown at or above this value (seconds) trigger a burst window. Disabled when explicit trigger overrides are set."
L["Reset Burst Injection desc"] = "Reset all burst injection settings to defaults."
L["Burst Trigger Override"] = "Trigger Override"
L["Burst Trigger Override desc"] = "Optional: specify exact trigger spells instead of using the cooldown threshold. When this list has entries, the threshold slider is ignored."
L["Clear Trigger Overrides"] = "Clear Overrides"
L["Clear Trigger Overrides desc"] = "Remove all trigger overrides and revert to cooldown threshold detection."
L["No Burst Trigger Overrides"] = "No trigger overrides set — using cooldown threshold detection."
L["Detected Burst Triggers"] = "|cFF9966FFDetected triggers:|r"
L["Detected Burst Triggers None"] = "none (no rotation spells meet the threshold)"
L["Burst Injection Spells"] = "Injection Spells"
L["Burst Injection Priority List"] = "Injection Priority List"
L["Burst Injection Priority desc"] = "Spells to inject at position 1 during burst. First usable spell wins. Reorder to set priority."
L["Restore Burst Injection Defaults desc"] = "Reset the injection list to default spells for your class and spec"
L["No Burst Injection Spells"] = "No injection spells configured. Use the button below to add one, or click Restore Class Defaults."
