...
L["Show Usability Tint desc"] = "Tint icons by state: blue when out of resources, gray when unavailable (on cooldown, wrong form, etc), red when the target is out of range."
...
L["Ability Pins Note"] = "Pins are shared across specs. Proc Priority applies in every list; Always Show and Hold Until Charged apply to the rotation queue."
L["Ability Pins"] = "Pins"
