...
L["Interrupt Mode desc"] = "Controls when the interrupt reminder icon appears and which ability it suggests. Note: does not trigger on training dummies or trivial adds."
L["Sounds"] = "Sounds"
