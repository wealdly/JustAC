...
-- Hotkey Options
L["Hotkey Options"] = "快捷键选项"
L["Hotkey Font"] = "快捷键字体"
L["Font for hotkey text"] = "用于快捷键文本的字体"
L["Hotkey Size"] = "快捷键大小"
L["Size of hotkey text"] = "快捷键文本大小"
L["Hotkey Color"] = "快捷键颜色"
L["Color of hotkey text"] = "快捷键文本颜色"
L["Parent Anchor"] = "父级锚点"
L["Anchor point of hotkey text relative to icon"] = "快捷键文本相对于图标的锚点位置"
L["Hotkey Anchor"] = "快捷键锚点"
L["Which point on the hotkey text attaches to the anchor"] = "快捷键文本的哪个点附加到锚点"
L["First X Offset"] = "首个X偏移"
L["Horizontal offset for first icon hotkey text"] = "首个图标快捷键文本的水平偏移"
L["First Y Offset"] = "首个Y偏移"
L["Vertical offset for first icon hotkey text"] = "首个图标快捷键文本的垂直偏移"
L["Queue X Offset"] = "队列X偏移"
L["Horizontal offset for queued icons hotkey text"] = "队列图标快捷键文本的水平偏移"
L["Queue Y Offset"] = "队列Y偏移"
L["Vertical offset for queued icons hotkey text"] = "队列图标快捷键文本的垂直偏移"
L["Outline Mode"] = "描边模式"
L["Font outline and rendering flags for hotkey text"] = "快捷键文本的字体描边和渲染选项"
L["None"] = "无"
L["Outline"] = "描边"
L["Thick Outline"] = "粗描边"
L["Monochrome"] = "单色"
L["Outline + Monochrome"] = "描边 + 单色"
L["Thick Outline + Monochrome"] = "粗描边 + 单色"
