...
L["Interrupt Mode Disabled"] = "已禁用 — 不显示打断图标"
L["Interrupt Mode Kick Only"] = "仅踢技 — 对可打断施法建议踢技"
L["Interrupt Mode CC Shielded"] = "踢技 + 控制 — 也对不可打断施法建议眩晕/恐惧"
L["Interrupt Mode CC Prefer"] = "优先控制 — 眩晕优于踢技；Boss使用踢技"
...
L["Disable Blizzard Highlight desc"] = "禁用此选项可提高性能。暴雪的AssistedCombatManager每帧运行一个循环，扫描所有动作条按钮以显示蓝色高亮光效。JustAC已在自己的队列中显示相同信息。关闭它可以消除该循环，并防止在插件负载较重时出现「脚本执行时间超限」错误。此设置跨会话保留。"
