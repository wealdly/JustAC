...
L["Standard Queue description"] = "配置法术队列的外观和行为。"
...
L["Restore Class Defaults desc"] = "将防御列表重置为职业默认法术"
...
L["Reset Standard Queue desc"] = "将所有标准队列设置重置为默认值。"
...
L["Overlay Font Scale"] = "覆盖层字体缩放"
L["Overlay Font Scale desc"] = "姓名板覆盖层的独立字体缩放。"
