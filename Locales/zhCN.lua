...
L["Nameplate Defensive Count"] = "防御槽位"
L["Show Interrupt Reminder"] = "显示打断提醒"
L["Show Interrupt Reminder desc"] = "目标施放可打断法术时显示打断或控制提醒图标。"
L["CC Regular Mobs"] = "优先控制普通怪物"
L["CC Regular Mobs desc"] = "对非首领怪物优先使用控制技能（眩晕、瘤痪）而非打断。对首领始终使用打断。"
L["Nameplate Show Health Bar"] = "显示生命条"
L["Nameplate Show Health Bar desc"] = "在防御图标上方显示紧凑型玩家生命条。无可见防御时自动隐藏。"
L["Health Bar Position"] = "生命条位置"
L["Health Bar Position desc"] = "控制生命条相对于图标的位置。外侧：图标远端之外。内侧：姓名板和图标1之间。"
...
-- Icon Labels (21 keys)
L["Icon Labels"] = "图标标签"
L["Icon Labels desc"] = "自定义图标文本标签的字体大小、颜色和位置。标准队列和姓名板叠加层分别配置。"
L["Hotkey Text"] = "快捷键文本"
