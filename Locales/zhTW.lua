...
L["Standard Queue description"] = "設定法術佇列的外觀與行為。"
...
L["Restore Class Defaults desc"] = "將防禦清單重設為職業預設法術"
...
L["Reset Standard Queue desc"] = "將所有標準佇列設定重設為預設值。"
L["Reset Layout desc"] = "重設版面設定為預設值。"
L["Reset Offensive Display desc"] = "重設進攻顯示設定為預設值。"
L["Reset Defensive Display desc"] = "重設防禦顯示設定為預設值。"
L["Reset Appearance desc"] = "重設可見性和外觀設定為預設值。"
L["Reset Offensive desc"] = "重設進攻內容設定。黑名單不受影響。"
L["Reset Overlay desc"] = "重設所有覆蓋設定為預設值。"
L["Reset Defensives desc"] = "重設防禦內容設定。法術清單不受影響。"
...
L["Overlay Font Scale"] = "覆蓋層字型縮放"
L["Overlay Font Scale desc"] = "姓名板覆蓋層的獨立字型縮放。"
