...
L["Insert Procced Defensives desc"] = "在任何生命值時將觸發的防禦技能（勝利衝擊、免費治療）加入佇列。"
...
L["Custom Queue Sink Cooldowns desc"] = "將冷卻中、無充能、目前無法使用（如目標生命值高於斬殺線時的斬殺）或超出射程的技能移到佇列末端。關閉：留在其列出的位置。"
...
L["Include Fears desc"] = "建議恐懼類群體控制（例如威嚇怒吼、心靈尖嘯）作為打斷的備選。預設關閉：恐懼在目標受到傷害的瞬間便會解除並驅散敵人，在團隊中具有破壞性。"
L["Sounds"] = "聲音"
