...
L["Nameplate Defensive Count"] = "防禦欄位"
L["Show Interrupt Reminder"] = "顯示斷法提醒"
L["Show Interrupt Reminder desc"] = "目標施放可打斷法術時顯示斷法或控制提醒圖示。"
L["CC Regular Mobs"] = "優先控制普通怪物"
L["CC Regular Mobs desc"] = "對非首領怪物優先使用控制技能（暈眩、瘤痺）而非斷法。對首領始終使用斷法。"
L["Nameplate Show Health Bar"] = "顯示生命條"
L["Nameplate Show Health Bar desc"] = "在防禦圖示上方顯示緊湊型玩家生命條。無可見防禦時自動隱藏。"
L["Health Bar Position"] = "生命條位置"
L["Health Bar Position desc"] = "控制生命條相對於圖示的位置。外側：圖示遠端之外。內側：名條和圖示1之間。"
...
-- Icon Labels (21 keys)
L["Icon Labels"] = "圖示標籤"
L["Icon Labels desc"] = "自訂圖示文字標籤的字型大小、顏色和位置。標準佇列和名條覆蓋層分別設定。"
L["Hotkey Text"] = "快捷鍵文字"
