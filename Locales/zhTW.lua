...
-- Hotkey Options
L["Hotkey Options"] = "快捷鍵選項"
L["Hotkey Font"] = "快捷鍵字型"
L["Font for hotkey text"] = "用於快捷鍵文字的字型"
L["Hotkey Size"] = "快捷鍵大小"
L["Size of hotkey text"] = "快捷鍵文字大小"
L["Hotkey Color"] = "快捷鍵顏色"
L["Color of hotkey text"] = "快捷鍵文字顏色"
L["Parent Anchor"] = "父層錨點"
L["Anchor point of hotkey text relative to icon"] = "快捷鍵文字相對於圖示的錨點位置"
L["Hotkey Anchor"] = "快捷鍵錨點"
L["Which point on the hotkey text attaches to the anchor"] = "快捷鍵文字的哪個點附加到錨點"
L["First X Offset"] = "首個X偏移"
L["Horizontal offset for first icon hotkey text"] = "首個圖示快捷鍵文字的水平偏移"
L["First Y Offset"] = "首個Y偏移"
L["Vertical offset for first icon hotkey text"] = "首個圖示快捷鍵文字的垂直偏移"
L["Queue X Offset"] = "佇列X偏移"
L["Horizontal offset for queued icons hotkey text"] = "佇列圖示快捷鍵文字的水平偏移"
L["Queue Y Offset"] = "佇列Y偏移"
L["Vertical offset for queued icons hotkey text"] = "佇列圖示快捷鍵文字的垂直偏移"
L["Outline Mode"] = "描邊模式"
L["Font outline and rendering flags for hotkey text"] = "快捷鍵文字的字型描邊與渲染選項"
L["None"] = "無"
L["Outline"] = "描邊"
L["Thick Outline"] = "粗描邊"
L["Monochrome"] = "單色"
L["Outline + Monochrome"] = "描邊 + 單色"
L["Thick Outline + Monochrome"] = "粗描邊 + 單色"
