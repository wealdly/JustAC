...
L["Interrupt Mode Disabled"] = "Désactivé — Aucune suggestion d'interruption"
L["Interrupt Mode Kick Only"] = "Kick uniquement — Suggérer le kick pour les sorts interruptibles"
L["Interrupt Mode CC Shielded"] = "Kick + CC — Suggérer aussi étourdissement/peur pour les sorts protégés"
L["Interrupt Mode CC Prefer"] = "Préférer CC — Étourdissements plutôt que kicks sur cibles contrôlables ; kick sur les boss"
