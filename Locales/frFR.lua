...
L["Burst Injection Behavior Note"] = "La lueur violette met en évidence les sorts déclencheurs. Une fois le buff activé, les sorts prioritaires sont injectés en position 1."
