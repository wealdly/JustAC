...
L["Interrupt Alert Sound"] = "Alerte d'interruption"
...
L["Reset Appearance desc"] = "Réinitialiser les paramètres de visibilité et d'apparence."
L["Reset Offensive desc"] = "Réinitialiser les paramètres de contenu offensif. La liste noire n'est pas affectée."
L["Reset Overlay desc"] = "Réinitialiser tous les paramètres de l'Overlay à leurs valeurs par défaut."
L["Reset Defensives desc"] = "Réinitialiser les paramètres de contenu défensif. Les listes de sorts ne sont pas affectées."
...
L["Overlay Font Scale"] = "Taille de police overlay"
L["Overlay Font Scale desc"] = "Taille de police indépendante pour l'overlay de plaque de nom."
