...
L["Interrupt Alert Sound"] = "Alerta de interrupción"
...
L["Overlay Font Scale"] = "Escala de fuente del overlay"
L["Overlay Font Scale desc"] = "Escala de fuente independiente para el overlay de placas de nombre."
