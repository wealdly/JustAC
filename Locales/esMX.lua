...
L["Queue Settings"] = "Ajustes de cola"
...
L["disabled when Defensive Queue is enabled"] = "desactivado cuando la cola defensiva está habilitada"
...
-- Item Features
L["Items"] = "Objetos"
L["Allow Items in Spell Lists"] = "Permitir objetos en listas de hechizos"
L["Allow Items in Spell Lists desc"] = "Permitir agregar consumibles (pociones, piedras de salud) a las listas defensivas. La búsqueda también escaneará bolsas y barras de acción."
L["Auto-Insert Health Potions"] = "Insertar pociones de salud automáticamente"
L["Auto-Insert Health Potions desc"] = "Sugerir automáticamente una poción de sanación cuando la salud es crítica, incluso sin agregarla manualmente."
...
L["Interrupt Mode Disabled"] = "Desactivado — Sin sugerencias de interrupción"
L["Interrupt Mode Kick Only"] = "Solo Kick — Sugerir kick para hechizos interrumpibles"
L["Interrupt Mode CC Shielded"] = "Kick + CC — También sugerir aturdimiento/miedo para hechizos protegidos"
L["Interrupt Mode CC Prefer"] = "Preferir CC — Aturdimientos en vez de kicks en objetivos controlables; kick en jefes"
...
L["Show Gap-Closer Glow desc"] = "Muestra un brillo rojo en los íconos acercadores para resaltar que están disponibles."
