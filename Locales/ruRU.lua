...
L["Nameplate Defensive Count"] = "Макс. иконок"
...
L["Interrupt Mode Disabled"] = "Выключено — Без предложений прерывания"
L["Interrupt Mode Kick Only"] = "Только кик — Предлагать кик для прерываемых заклинаний"
L["Interrupt Mode CC Shielded"] = "Кик + КО — Также предлагать оглушение/страх для защищённых заклинаний"
L["Interrupt Mode CC Prefer"] = "Предпочесть КО — Оглушения вместо киков по контролируемым целям; кик по боссам"
L["Nameplate Show Health Bars"] = "Показать полосы здоровья"
...
L["Melee Range Spell ID"] = "Свой ID заклинания"
