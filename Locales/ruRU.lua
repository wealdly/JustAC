...
L["Nameplate Defensive Display Mode desc"] = "При низком здоровье: только когда здоровье падает ниже порога.\nТолько в бою: защитные иконки только в бою.\nВсегда: показывать постоянно."
...
L["Interrupt Alert Sound"] = "Оповещение прерывания"
...
L["Overlay Font Scale"] = "Размер шрифта оверлея"
L["Overlay Font Scale desc"] = "Независимый масштаб шрифта для оверлея на табличке."
